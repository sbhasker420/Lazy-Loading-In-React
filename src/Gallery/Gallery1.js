    ...
    return (
      ...
      <section className="gallery">
        <div className="galleryImage">
          {(this.state, items)}
          <Card src={this.state.data[0].download_url} />
          <Card src={this.state.data[1].download_url} />
          <Card src={this.state.data[2].download_url} />
          <Card src={this.state.data[3].download_url} />
          <Card src={this.state.data[4].download_url} />
          <Card src={this.state.data[5].download_url} />
          <Card src={this.state.data[6].download_url} />
          <Card src={this.state.data[7].download_url} />
          <Card src={this.state.data[8].download_url} />
        </div>
        {this.state.visible < this.state.items.length && (
          <button onClick={this.loadMore} className="loadMoreButton">
            Load More
          </button>
        )}
      </section>
